    ...
    <body>
        <div class="container">
            ...
            <div class="Berita pt-5">
                ...
                <br><br><br>
                <div class="berita">
                    <a href="tambahberita.php" class="btn btn-primary position-relative">Tambah Berita</a>
                    <br> <br>
                    <table border="0" cellspacing="0" cellpadding="5">
                        ...
                        <tr>
                            <td>
                                <a href="editberita.php?id=<?php echo $d['id']; ?>" class="btn btn-primary position-relative">EDIT</a>
                                <a href="hapusberita.php?id=<?php echo $d['id']; ?>" class="btn btn-outline-primary" onclick= "return confirm('Apakah anda yakin ingin menghapus ini ?')">HAPUS</a>
