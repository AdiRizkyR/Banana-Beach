            ...
            <div class="Fasilitas pt-5">
                ...
                <nav class="navbar bg-light p-3">
                        <div class="container-fluid">
                            <a class="navbar-brand"><h2>Food&Cafe</h2></a>
                                <form class="d-flex" role="search" action="foodcafe.php" method="get">
                ...
                <div class="fasilitas">
                    <table border="0" cellspacing="0" cellpadding="5">
                        ...
                        <tr>
                            <td>
                                <a href="edit.php?id=<?php echo $d['id']; ?>" class="btn btn-primary position-relative">EDIT</a>
                                <a href="hapus.php?id=<?php echo $d['id']; ?>" class="btn btn-outline-primary" onclick= "return confirm('Apakah anda yakin ingin menghapus ini ?')">HAPUS</a>
                            </td>
                        </tr>
