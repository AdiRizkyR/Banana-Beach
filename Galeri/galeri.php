                    ...
                    <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarNavAltMarkup" aria-controls="navbarNavAltMarkup" aria-expanded="false" aria-label="Toggle navigation">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav ms-auto">
                                ...
                                <a class="nav-link active" aria-current="page" href="galeri.php"><u>Galeri</u></a>
                                <a class="nav-link active" aria-current="page" href="../fasilitas/fasilitas.php">Fasilitas</a>
                ...
                <div class="container">
                    <nav class="navbar bg-light p-3">
                        <div class="container-fluid">
                            <a class="navbar-brand"><h2>Galeri</h2></a>
                                <form class="d-flex" role="search" action="galeri.php" method="get">
                    ...
                    <br>
                    <br>
                    <a href="tambah.php" class="btn btn-primary position-relative">Tambah Data</a>
                    <br>
                    <br>
                    <div class="galeri">
                        <table border="0" cellspacing="0" cellpadding="5">
                            <?php
                                ...
                                if(isset($_GET['cari'])){
                                    ...
                                    $sql2 = "select * from galeri where nama like '%".$cari."%' or tanggal
                                    like '%".$cari."%'"; 
                            ...
                            ?>
                                ...
                                <tr>
                                    <td><img src="../gambar/<?php echo $d['foto1'] ?>" width="380px" height="380px"></td>
                                    <td><img src="../gambar/<?php echo $d['foto2'] ?>" width="380px" height="380px"></td>
                                    <td><img src="../gambar/<?php echo $d['foto3'] ?>" width="380px" height="380px"></td>
                                </tr>
                                    <td>
                                        <a class="btn btn-primary position-relative" href="edit.php?id=<?php echo $d['id']; ?>">EDIT</a>
                                        <a class="btn btn-outline-primary" href="hapus.php?id=<?php echo $d['id']; ?>" onclick="return confirm('Apakah Anda Yakin Ingin Menghapus Data Ini?')">HAPUS</a>
                                    </td>
                                </tr>
                            <?php
                                }
