    ...
    <body>
        <div class="container">
            ...
            <div class="Fasilitas pt-5">
                <br>
                <a href="foodcafe.php"><h3><center><u>Food&Cafe</u></center></h3></a>
                <br><br>
                <div class="fasilitas">
                    ...
                    <br> <br>
                    <a href="foodcafe.php"><p style="text-align: center;">Selengkapnya</p></a>
                </div>
            </div>
            <!-- akhir food&cafe -->
            ...
            <div class="Fasilitas pt-5">
                <br> <br>
                <a href="hotel.php"><h3><center><u>Hotel</u></center></h3></a>
                <br><br>
                <div class="fasilitas">
                    <table border="0" cellspacing="0" cellpadding="5">
                        <?php
                    ...
                    <br> <br>
                    <a href="hotel.php"><p style="text-align: center;">Selengkapnya</p></a>
                </div>
            </div>
            <!-- akhir hotel -->
