...
if (isset($_POST['simpan'])) {
    ...
    $query = "UPDATE hotel SET foto='$foto', nama='$nama', jarak='$jarak', buka='$buka', tutup='$tutup', narasi='$narasi' WHERE id='$id'";
    $query_run = mysqli_query($con, $query);

    if ($query_run) {
        move_uploaded_file($_FILES['foto']['tmp_name'], "../gambar/".$_FILES['foto']['name']);
        echo '<script>alert("Berhasil Update Data!");window.location="hotel.php"</script>';
    }
    else {
        echo '<script>alert("Gagal Update Data!");window.location="hotel.php"</script>';
    }
}
